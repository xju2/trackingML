...
def train(event, n_epochs):
    ...
    real_tracks_out_name = 'reak_tracks_pad.pkl'
    fake_tracks_out_name = 'fake_tracks_pad.pkl'
    ...
    torch.save(model.state_dict(), "model_isgoodtrack")

    with open('epoch_list.pkl', 'wb') as fp:
        pickle.dump(epoch_list, fp)

    with open('loss_train.pkl', 'wb') as fp:
...
if __name__ == "__main__":
    ...
    train(event=options.path, n_epochs=options.iters)
